...
/**
 * See documentation: https://devboldly.github.io/react-use-window-localstorage/useLocalStorageNumber
 *
 ...
 */
export declare function useLocalStorageNumber(keyName: string, defaultValue?: number | null): LocalStorageItem<number>;
